...
x = 200
plt.plot(data[x:,0]-18.5241 ,data[x:,1]/2.0,color = "r",linestyle = "--",label = "Spin up")
plt.plot(data[x:,0]-18.5241 ,-data[x:,2]/2.0,color = "b", linestyle = "--", label = "Spin down")
...
plt.title("DOS - Cobalt hcp ",fontweight = "bold")
plt.grid(True)
plt.tight_layout()
plt.legend()

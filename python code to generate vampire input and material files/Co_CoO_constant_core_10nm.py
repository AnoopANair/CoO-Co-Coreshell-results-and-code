...
inner_core_dia = 10
outer_layer_thickness = [0.5,1,1.5,2,2.5,3,3.5,4,4.5,5]
foldername = "outputfiles"
folder_input = "inputfiles"
folder_mat = "material_files"

for data in outer_layer_thickness :
    diameter = inner_core_dia + 2*data
    ratio = (inner_core_dia*0.5)/(diameter*0.5)
